            ...
            <>
              <div className="fixed top-[20%] left-[40%] bg-purple-900 p-8 rounded-lg">
                ...
                <div className="flex flex-row items-start my-4">
                  ...
                  <div className="text-end">
                    <p>{HelperService.formatHeight(character.height)}m</p>
                    <p>{HelperService.formatMass(character.mass)}kg</p>
                    <p>{HelperService.formatDate(character.created)}</p>
                    <p>{HelperService.formatNumberOfFilms(character.films)}</p>
                    <p>{character.birth_year}</p>
                    <h3>{homeworld.name}</h3>
                    <p>{homeworld.terrain}</p>
                    <p>{homeworld.climate}</p>
                ...
                <p>{HelperService.formatSpecies(character.species)}</p>
